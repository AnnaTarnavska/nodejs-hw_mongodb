...
contactsRouter.post('/contacts', upload.single('photo'), validateBody(createValidationSchema), ctrlWrapper(createContactsController));
contactsRouter.patch('/contacts/:contactId', upload.single('photo'), validateBody(updateValidationSchema), ctrlWrapper(patchContactByIdController));
